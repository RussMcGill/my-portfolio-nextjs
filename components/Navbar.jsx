...
export default function Navbar({ theme, setTheme }) {
  ...
  return (
    <div className='fixed w-full h-20 shadow-xl z-50 bg-background dark:bg-slate-800'>
        ...
        <div>
          <ul className='hidden md:flex'>
            ...
            <button onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}>
              <li>{theme === 'light' ? <MdDarkMode className='ml-10' /> : <MdOutlineLightMode className='ml-10' />}</li>
            </button>
          </ul>
          ...
          <div className='flex flex-col justify-between'>
            <div className='flex w-full items-center justify-between'>
              ...
              <div className='flex flex-col-reverse gap-2'>
                <button
                  className='rounded-full shadow-lg light:shadow-gray-400 dark:bg-slate-600 p-3'
                  onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
                >
                  {theme === 'light' ? <MdDarkMode /> : <MdOutlineLightMode />}
                </button>
                <div className='rounded-full shadow-lg light:shadow-gray-400 dark:bg-slate-600 p-3 cursor-pointer'>
          ...
          <div className='py-4 flex flex-col'>
            ...
            <div className='pt-16'>
              ...
              <div className='flex items-center justify-between my-4 w-full sm:w-[80%]'>
                <div className='rounded-full shadow-lg light:shadow-gray-400 dark:bg-slate-600 p-3 cursor-pointer hover:scale-105 ease-in duration-300'>
