...
export default function MainInfo(second) {
  return (
    <div className='w-full h-screen text-center'>
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          <p className='uppercase text-sm tracking-widest text-gray-600'>let's build something awesome together</p>
          <h1 className='p-4 text-gray-700'>
            Hi, I'm <span className='text-[#5651e5]'>Russ</span>{' '}
          </h1>
